...
from torch_geometric.nn import GCNConv, Sequential, BatchNorm


class Mp_encoder(nn.Module):
    def __init__(self, use_data, hidden_dim, attn_drop, in_feat):
        ...
        self.intra = nn.ModuleList([
            Sequential('x, edge_index', [
                (GCNConv(in_feat, hidden_dim), 'x, edge_index -> x'),
